...
#ifdef DEBUG_MODE
template<typename T>
void print_input(T input){cout << "input: " << input << endl;}
void print_input(){cout << "input: " << endl;}
// #define print(input) cout << "input: " << input << endl
#else
#ifdef NO_PRINT
template<typename T>
void print_input(T input){}
void print_input(){}
// #define print(input)
#else
template<typename T>
void print_input(T input){cout << input << endl;}
void print_input(){cout << endl;}
// #define print(input) cout << input << endl
#endif
#endif
#define print(input) print_input(input)

#define FLOATS_PER_ORBIT 18
#define EPOCH_MJD 0
#define SEMI_MAJOR 1
#define ECCENTRICITY 2
#define INCLINE 3
#define LONG_ASCEND_NODE 4
#define ARG_PERI 5
#define MEAN_ANOMALY 6
#define SIGMA_SEMI_MAJOR 7
#define SIGMA_ECC 8
#define SIGMA_INCLINE 9
#define SIGMA_LONG_ASCEND 10
#define SIGMA_ARG_PERI 11
#define SIGMA_MEAN_ANOM 12
#define GM 13
#define MG 13
#define ABSOLUTE_MAGNITUDE 14
#define SIGMA_ABS_MAG 15
#define ALBEDO 16
#define TYPE_SIMPLE 17
#define SIMPLE_TYPE 17

#define BASE_FILE_LOC string("Reference_File/Asteroid_Data/Asteroid_Belt/")//R"(C:\Users\David\Documents\reference file\asteroid data\)"
...
Orbit inputFileHandler::generateOrbit(int index, float time0)
{
	...
	float absMag;
	if (orbitData[SIGMA_ABS_MAG] == 0)
		//if no error bars for absolute magnitude are given,
		//take it to be .2.
...
vector<Orbit> inputFileHandler::generateOrbits(vector<int> indices, float time0)
{
	...
	{
		output.push_back(generateOrbit(index, time0));
	}
	return output;
}
